...
class MeliClassifierFiles():
    ...
    _lang_class_weights_filename: str = '{}_class_weights.json'
    ...
    @property
    def lang_class_weights(self) -> str:
        return str(self._processed_dir/self._lang_class_weights_filename.format(self.lang))
